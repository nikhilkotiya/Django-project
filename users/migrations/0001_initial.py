# Generated by Django 3.1.3 on 2021-05-01 09:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email2', models.EmailField(blank=True, max_length=254, null=True, unique=True, verbose_name='alternative mail address')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mobile_no', models.IntegerField(blank=True, null=True, verbose_name='mobile number')),
                ('is_email_confirmed', models.BooleanField(blank=True, default=False, null=True)),
                ('is_email2_confirmed', models.BooleanField(blank=True, default=False, null=True)),
                ...
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=users.models.Profile.f, verbose_name='profile image')),
